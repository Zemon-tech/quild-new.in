...
export default function CommunityHero() {
  ...
  const lines = useMemo(() => splitIntoLines('The builders\nbehind Quild.'), [])
      ...
      >
        ...
        >
          ...
          <div className="mt-8 overflow-hidden">
            ...
            >
              {lines.map((line, idx) => (
                <span key={`${line}-${idx}`} className="block overflow-hidden">
          ...
          >
            Everyone who has built with, taught through, or contributed to Quild —
            cohort participants, mentors, researchers, partners, and the team.
          </p>
          ...
          >
            ...
            >
              <Link href="/community">MEMBER DIRECTORY →</Link>
            </Button>
          </div>
        </div>
        ...
        >
          <div
            className="origin-top-right -rotate-90 whitespace-nowrap font-mono text-[0.65rem] uppercase tracking-[0.12em] text-white/50 mt-30"
          >
            COHORTS → MENTORS → PARTNERS → RESEARCH → CREATORS
          </div>
        ...
        <div className="col-span-12 mt-auto border-t border-white/20 py-6">
          ...
          >
            SMALL BY CHOICE&nbsp;&nbsp;/&nbsp;&nbsp;SERIOUS BY DEFAULT&nbsp;&nbsp;/&nbsp;&nbsp;BUILDING WITH AI&nbsp;&nbsp;/&nbsp;&nbsp;SHIPPING IN PUBLIC
          </div>
        </div>
      </div>
    </section>

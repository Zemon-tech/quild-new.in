...
export default function BlogHero() {
  ...
  const lines = useMemo(
    () => splitIntoLines(featuredPost.title),
    [featuredPost.title]
  );
      ...
      >
        ...
        >
          ...
          <div className="mt-8 overflow-hidden">
            <h1
              className="text-[clamp(3.8rem,7.5vw,5rem)] font-semibold leading-[0.92] tracking-[-0.02em] text-white"
              style={
                isMobile
                  ? {
        ...
        >
          ...
          <div className="origin-top-right -rotate-90 whitespace-nowrap font-mono text-[0.65rem] uppercase tracking-[0.12em] text-white/50 mt-30">
            INSIGHTS · TUTORIALS · THOUGHTS · AND MORE
          </div>
          ...
          <div className="mt-auto">
            ...
            >
              [ {blogPosts.length} ARTICLES — BLOG ]
            </Link>
          </div>
        </div>
        ...
        <div className="col-span-12 mt-auto border-t border-white/20 py-6">
          ...
          >
            DEEP DIVE · TUTORIALS · CASE STUDIES · INDUSTRY INSIGHTS
          </div>
        </div>
      </div>
    </section>
